    ...
    <div className="flex flex-col h-full">
      <div className="flex items-center justify-between border-b-2 border-foreground px-4 py-2">
        <span className="text-[10px] tracking-widest text-muted-foreground uppercase font-mono">
          sparse_tree.visualizer
        </span>
        <span className="text-[10px] tracking-widest text-muted-foreground font-mono">BLOBLESS_CANVAS</span>
      </div>
      <div className="flex-1 flex items-center justify-center p-4 bg-background overflow-hidden">
        <canvas
          ...
          aria-label="Sparse checkout tree visualization"
          role="img"
        />
      </div>
    </div>
