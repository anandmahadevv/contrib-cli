        ...
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8">
            {[
              ...
              <motion.a
                ...
                className="text-xs font-mono tracking-widest uppercase text-muted-foreground hover:text-[#ea580c] transition-colors duration-200 font-bold"
              >
                {link.label}
              </motion.a>
            ))}
          ...
          >
            ...
            <motion.a
              ...
              whileTap={{ scale: 0.98 }}
              className="bg-foreground text-background px-4 py-2 text-xs font-mono tracking-widest uppercase font-bold hover:bg-[#ea580c] transition-colors inline-block"
            >
              $ npx gsoc-contrib
            </motion.a>
          </motion.div>
